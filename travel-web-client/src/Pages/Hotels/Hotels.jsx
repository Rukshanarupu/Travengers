import hotel1 from '../../assets/Destinations/Rectangle 26.png'
import hotel2 from '../../assets/Destinations/Rectangle 27.png'
import hotel3 from '../../assets/Destinations/Rectangle 28.png'
import { FaStar } from 'react-icons/fa';

const Hotels = () => {
    return (
        <div className='max-w-screen-xl mx-auto w-full text-left my-10 '>
            <p>252 stays Apr 13-17 3 guests</p>
            <h4 className='text-2xl font-neue'>Stay in Cox's Bazar</h4>
